...
Doorkeeper.configure do
  ...
  resource_owner_authenticator do
    raise "This should not be needed as I am not using Authorization code flow and generating tokens manually"
    User.find_by(uuid: session[:user_uuid]) || redirect_to(new_user_session_url)
  end
  use_refresh_token
